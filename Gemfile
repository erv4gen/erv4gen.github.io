...
gem "jekyll", "~> 3.9.3" # As of late 2023/early 2024, 3.9.x is common for GH Pages

# Specify the theme gem
gem "jekyll-theme-minimal", "~> 0.2.0" # Check for latest version if needed

# For GitHub Flavored Markdown
gem "kramdown-parser-gfm"

# Add webrick for Jekyll server in Ruby 3+
gem "webrick"
